...
**分析视角规则：**
- 亮点时刻和关键失误必须站在目标棋手（默认：aaronwang2026）的视角描述
- 如果 aaronwang2026 是执白：分析他的着法，标注为 `1.xxx`、`2.xxx` 等
- 如果 aaronwang2026 是执黑：分析他的着法，标注为 `1...xxx`、`2...xxx` 等
- ⚠️ 关键失误：指的是 aaronwang2026 的失误，不是对手的失误
- 🎯 亮点时刻：指的是 aaronwang2026 的妙着，不是对手的妙着
...
**保存路径：**
```
~/.openclaw/workspace-chess-ai-coach/analyses/
```
